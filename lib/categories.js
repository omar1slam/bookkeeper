...
/** Like normalizeLabel, but also treats "&" and "and" as equivalent ("Food & Beverage" ≡ "food and beverage"). */
export function canonicalizeLabel(s) {
  return normalizeLabel(s).replace(/&/g, " and ").replace(/\s+/g, " ").trim();
}
